// Shared blog metadata — used by BlogsPage.jsx (the listing) and
// BlogSidebar.jsx (the "more guides" rail on every post). Kept in one place
// so a new post only needs registering here once, not duplicated across
// both consumers.
